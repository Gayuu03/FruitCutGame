...
$(function(){
    ...
    $("#startReset").click(function () {
        if(playing == true){
            ...
            $('#fruitcontainer').addClass('knifeCursor')
            // $('body.playing').css('cursor', 'url("Knife2Resize3.png"), auto');
        }
    function resumeGame(){
        $('.pause').show();
        $('.play').hide();
    ...
    function toggleHelpPausePlay(){
        ...
        $(".help, .pause, .play").click(function(){
            toggleHelpPausePlay();
    });
  ...
  function chooseRandom(){
   ...
   function stopAction(){
    ...
    // To open/close the popup window 
    ...
    // The info image at the right corner
